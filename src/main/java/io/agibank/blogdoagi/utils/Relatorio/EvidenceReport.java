package io.agibank.blogdoagi.utils.Relatorio;
...
import static io.agibank.blogdoagi.core.DriverFactory.*;
...
public class EvidenceReport {
    ...
    public static void gerarRelatorio(String titulo, String acao) {
      ...
      if (!rootsPath.exists())
        ...
        fileReport = rootsPath + "/" + nomeCenario + ".html";
        ...
        try {
            ...
            if (novoCenario) {
                ...
                writer.println("<tr class='evidencia'>");
                writer.println("<td class='evidencia' colspan=3 > AMBIENTE: </td><td class='evidencia' >"+ambiente+"</td></tr><tr></table></p>");
